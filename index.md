...
<main class="portal">
  ...
  <!-- Bio panel -->
  <div class="portal-panel panel-bio">
    <div class="panel-bg"></div>
    <div class="panel-content bio-content">
      <div class="bio-avatar">
        <img src="/assets/images/headshot.jpg" alt="Lewis Farrell" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
        <div class="bio-avatar-placeholder">LF</div>
      </div>
      <div class="bio-text">
    ...
    <div class="portal-content">
      ...
      <div class="pc-reveal">
        ...
        <div class="pc-chips">
          ...
          <span class="pc-chip">Affinity</span>
          <span class="pc-chip">Book</span>
        </div>
        <div class="pc-entry">
          Explore Ideas
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
...
<footer class="portal-bottom">
  <div class="portal-credentials">
    ...
    <span>Oxford Economics &amp; Management</span>
    <span class="cred-dot"></span>
    <span>Intimacy Economist</span>
  </div>
